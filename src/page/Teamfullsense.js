...
const Teamfullsense = ({navigation}) => {
  return (
    <ScrollView style={{flex: 1, backgroundColor: '#AD62FB'}}>
      ...
      <View
        ...
        <Image
          ...
          source={require('../assets/Logo/fullsense.png')}
        />
      ...
      <View style={{marginHorizontal: 41, marginTop: 15}}>
        ...
        <Table>
          ...
          <Rows
            ...
            data={[
              ['ChAlalala', 'Chanitpak Suwanaprateep'],
              ['LAMMYSNAX', 'Elamrahim Khanpathan'],
              ['PTC', 'Kititkawin Rattanasukol'],
              ['JohnOlsen', 'Chanawin Nakchain'],
              ['SuperBusS', 'Nattawat Yoosawat'],
            ]}
          />
        </Table>
      </View>
